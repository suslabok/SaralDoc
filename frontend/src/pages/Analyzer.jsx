  ...
  return (
    <div className="analyzer-page">
      <div className="analyzer-header">
        <h1 className="analyzer-title">📄 Document Analyzer</h1>
        <p className="analyzer-subtitle">
          Paste or upload Nepali/English legal documents for AI analysis
        </p>
      </div>
        ...
        <div className="input-section">
          ...
          <div className="action-buttons">
            <button
              ...
              onClick={
                inputMethod === "paste" ? handleAnalyzeText : handleAnalyzeFile
              }
              disabled={
                      ...
                      <div className="obligations-list">
                        {results.obligations.map((obligation, idx) => (
                          <div key={idx} className="result-item obligation">
                            ...
                            <p className="item-text">{obligation.obligation}</p>
